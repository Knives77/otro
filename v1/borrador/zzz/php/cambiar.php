  ...
  <body>
    ...
    <div id='form'>
      <form action='update.php'>
        ...
        <label>Nombre    :   </label>
        <input type='text' id='nam' name='name' value='test'/><br />
        <label>Email         :   </label>
        <input type='email' id='eml' name='email' value='test@test.com'/><br />
        <label>Password   :   </label>
        <input type='password' id='pass' name='password' value='test'/><br />
